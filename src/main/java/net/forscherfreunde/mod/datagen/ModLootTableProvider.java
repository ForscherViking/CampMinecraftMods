...
public class ModLootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        addDrop(ModBlocks.GetBlock("ruby_block"));
        addDrop(ModBlocks.GetBlock("ruby_glass"));

        addDrop(ModBlocks.GetBlock("ruby_ore"), copperLikeOreDrops(ModBlocks.GetBlock("ruby_ore"), ModItems.GetItem("ruby")));
